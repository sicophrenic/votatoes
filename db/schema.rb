...
ActiveRecord::Schema.define(version: 20131029002058) do
  ...
  create_table "tvdbobjs", force: true do |t|
    t.string   "name"
    t.integer  "series_id"
    t.text     "description"
    t.string   "image_url"
  ...
  add_index "votes", ["user_id", "votato_id"], name: "index_votes_on_user_id_and_votato_id", unique: true
